...
const bastionInstance = new aws.ec2.Instance(
  `${infraConfigResources.idPrefix}-bastion-${$app.stage}`,
  {
    ...
    sudo aws s3 cp s3://langfuse-clickhouse-script-production/clickhouse/production/backup_clickhouse.sh /home/ssm-user/clickhouse-ops/bin/backup_clickhouse.sh
    sudo aws s3 cp s3://langfuse-clickhouse-script-production/clickhouse/production/restore_clickhouse.sh /home/ssm-user/clickhouse-ops/bin/restore_clickhouse.sh
